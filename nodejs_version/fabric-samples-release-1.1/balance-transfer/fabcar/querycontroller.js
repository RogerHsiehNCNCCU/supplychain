...
return{
    ...
    query_queryAllDatas: function(req, res){
        ...
        //client = new hfc();
        return hfc.newDefaultKeyValueStore({ path: store_path });
        }).then((wallet) => {
            console.log("Set wallet path, and associate user ", user_id, " with application");
        ...
        return client.getUserContext(user_id, true);
        }).then((user) => {
